...
export const cloudCatalog: Record<CloudProvider, CloudComponentDef[]> = {
  ...
  aws: [
    { id: 'generic-trigger-user', name: 'User Traffic', category: 'Triggers', provider: 'aws', icon: 'Users', isTrigger: true },
    { id: 'generic-trigger-scheduler', name: 'Scheduler', category: 'Triggers', provider: 'aws', icon: 'Clock', isTrigger: true },
    { id: 'generic-trigger-webhook', name: 'Webhook', category: 'Triggers', provider: 'aws', icon: 'Webhook', isTrigger: true },
    { id: 'generic-trigger-events', name: 'Event Source', category: 'Triggers', provider: 'aws', icon: 'Events', isTrigger: true },
    { id: 'generic-trigger-error', name: 'Error', category: 'Triggers', provider: 'aws', icon: 'Error', isTrigger: true },
  ...
  azure: [
    { id: 'generic-trigger-user', name: 'User Traffic', category: 'Triggers', provider: 'azure', icon: 'Users', isTrigger: true },
    { id: 'generic-trigger-scheduler', name: 'Scheduler', category: 'Triggers', provider: 'azure', icon: 'Clock', isTrigger: true },
    { id: 'generic-trigger-webhook', name: 'Webhook', category: 'Triggers', provider: 'azure', icon: 'Webhook', isTrigger: true },
    { id: 'generic-trigger-events', name: 'Event Source', category: 'Triggers', provider: 'azure', icon: 'Events', isTrigger: true },
    { id: 'generic-trigger-error', name: 'Error', category: 'Triggers', provider: 'azure', icon: 'Error', isTrigger: true },
  ...
  gcp: [
    { id: 'generic-trigger-user', name: 'User Traffic', category: 'Triggers', provider: 'gcp', icon: 'Users', isTrigger: true },
    { id: 'generic-trigger-scheduler', name: 'Scheduler', category: 'Triggers', provider: 'gcp', icon: 'Clock', isTrigger: true },
    { id: 'generic-trigger-webhook', name: 'Webhook', category: 'Triggers', provider: 'gcp', icon: 'Webhook', isTrigger: true },
    { id: 'generic-trigger-events', name: 'Event Source', category: 'Triggers', provider: 'gcp', icon: 'Events', isTrigger: true },
    { id: 'generic-trigger-error', name: 'Error', category: 'Triggers', provider: 'gcp', icon: 'Error', isTrigger: true },
  ...
  oracle: [
    { id: 'generic-trigger-user', name: 'User Traffic', category: 'Triggers', provider: 'oracle', icon: 'Users', isTrigger: true },
    { id: 'generic-trigger-scheduler', name: 'Scheduler', category: 'Triggers', provider: 'oracle', icon: 'Clock', isTrigger: true },
    { id: 'generic-trigger-webhook', name: 'Webhook', category: 'Triggers', provider: 'oracle', icon: 'Webhook', isTrigger: true },
    { id: 'generic-trigger-events', name: 'Event Source', category: 'Triggers', provider: 'oracle', icon: 'Events', isTrigger: true },
    { id: 'generic-trigger-error', name: 'Error', category: 'Triggers', provider: 'oracle', icon: 'Error', isTrigger: true },
